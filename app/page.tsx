  ...
  <div className="max-w-7xl mx-auto px-6 lg:px-12">
    ...
    <div className="grid lg:grid-cols-3 gap-8">
      ...
      {[
        ...
        {
          name: "Julia M.",
          text: "Rezerwacja przez Booksy działa błyskawicznie, a efekt paznokci przepiękny.",
        },
        {
          name: "Karolina W.",
          text: "Piękne wnętrze, profesjonalizm i atmosfera jak w luksusowym SPA.",
        ...
        <div
          key={index}
          className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 backdrop-blur-xl hover:border-[#D4B483]/40 transition-all duration-500"
        >
          <div className="flex gap-1 text-[#D4B483] mb-6 text-xl">
            ★★★★★
          </div>
